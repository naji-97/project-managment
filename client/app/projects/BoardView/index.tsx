            ...
            <div className="mb-3 flex w-full">
                ...
                <div className="flex w-full items-center justify-between rounded-e-lg bg-white px-5 py-4 dark:bg-dark-secondary">
                    ...
                    <div className="flex items-center gap-1">
                        <button title="More" className="flex h-6 w-5 items-center justify-center dark:text-neutral-500">
...
// console.log(task.attachments, 'This is TAASKS ATTACHMENTS');
    ...
    return (
        <div
            ...
            className={`mb-4 rounded-md bg-white shadow dark:bg-dark-secondary ${isDragging ? "text-red-600" : "opacity-100"
                }`}
        >
            ...
            <div className="p-4 md:p-6">
                <div className="flex items-start justify-between">
                    ...
                    <button title="More" className="flex h-6 w-4 flex-shrink-0 items-center justify-center dark:text-neutral-500">
                        <EllipsisVertical size={26} />
                    </button>
                </div>
